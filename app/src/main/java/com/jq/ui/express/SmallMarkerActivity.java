...
public class SmallMarkerActivity extends Activity {
    ...
    // 订单信息
    private String mnumberLeft = null; // 校准编号左
    private String produceTimeLeft = null;//校准时间左
    private String limiteddateLeft = null; // 到期时间左

    private String mnumberRight = null; // 校准编号右
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.small_marker_activity);
    ...
    private void getPrintData() {
        //左标签
        mnumberLeft = ((EditText) findViewById(R.id.numberLeft))
                .getText().toString();
        produceTimeLeft = ((EditText) findViewById(R.id.producedateLeft)).getText().toString();
        limiteddateLeft = ((EditText) findViewById(R.id.limiteddateLeft)).getText().toString();

        //右标签
        mnumberRight = ((EditText) findViewById(R.id.numberRight))
                .getText().toString();
...
//			jpl.feedNextLabelEnd(0);
            ...
            jpl.page.end();
            jpl.page.print();
            jpl.feedNextLabelEnd(0);//printer.jpl.feedNextLabelEnd(48);//printer.jpl.feedNextLabelBegin();
            int i = 0;
            for (i = 0; i < 10; i++) {
                try {
                    Thread.sleep(1500);
